...
try {
      ...
      const systemMessage = {
        role: "system",
        content: "You are the Betwo Tech Company AI assistant. Your purpose is to help users understand our company, our services (Custom Software Development, Mobile Apps, System Integration), and to provide our contact information when asked.",
      };

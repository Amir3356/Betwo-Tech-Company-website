            ...
            <ul className="space-y-4">
              <li className="group">
                <div className="flex items-start gap-3 p-3 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800 transition-all duration-300">
                  <div className="w-10 h-10 rounded-lg bg-slate-400/10 dark:bg-slate-400/20 flex items-center justify-center text-slate-600 dark:text-slate-300 shrink-0 group-hover:scale-110 transition-transform duration-300">
                    <MapPin size={18} />
                  </div>
                  <div>

            ...
            heroData.ctaButtons.map((button, index) => (
              button.primary ? (
                <a
                  key={index}
                  href={button.link}
                  className="px-8 py-3 rounded-full bg-slate-900 hover:bg-slate-800 dark:bg-sky-400 dark:hover:bg-sky-500 text-white dark:text-black font-extrabold text-lg transition-all flex items-center justify-center gap-2 shadow-lg shadow-slate-900/20"
                >
                ...
                <a
                  key={index}
                  href={button.link}
                  className="px-8 py-3 rounded-full bg-slate-900 hover:bg-slate-800 dark:bg-sky-400 dark:hover:bg-sky-500 text-white dark:text-black font-extrabold text-lg transition-colors shadow-sm"
                >
                  {button.text}
                </a>
              )

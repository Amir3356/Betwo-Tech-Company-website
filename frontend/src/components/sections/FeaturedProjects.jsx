              ...
              <div className="relative h-48 overflow-hidden bg-slate-100 dark:bg-slate-800">
                {project.image ? (
                  <img
                    ...
                    alt={project.title}
                    className="w-full h-full object-scale-down p-2 transition-transform duration-300 group-hover:scale-105"
                  />
                ) : (
                  <div className="w-full h-full flex items-center justify-center text-slate-400">
                    <Building2 size={48} className="text-fuchsia-500 dark:text-blue-400" />
                  </div>
                )}
              ...
              <div className="p-2">
                <div className="flex items-center gap-2 mb-2">
                  <span className="flex items-center gap-1 text-xs font-medium text-slate-500 dark:text-slate-400">
                    <CheckCircle size={14} className="text-fuchsia-500 dark:text-blue-400" /> {project.uptime} Uptime
                  </span>
        ...
        >
          {highlights.map((highlight) => (
            <div key={highlight} className="flex items-center gap-2 text-sm font-medium text-slate-600 dark:text-slate-400">
              <CheckCircle size={16} className="text-fuchsia-500 dark:text-blue-400" /> {highlight}
            </div>
          ))}
        </motion.div>
      </div>
